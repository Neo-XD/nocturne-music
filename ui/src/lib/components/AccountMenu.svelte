...
{#if menuOpen}
	...
	></button>
	<div
		class="fixed z-50 w-72 animate-in rounded-xl border border-border/80 bg-popover/85 p-4 text-popover-foreground shadow-2xl backdrop-blur-2xl duration-150 fade-in-0 zoom-in-95"
		style={anchor.style}
