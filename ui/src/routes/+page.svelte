...
<div {@attach watchScroll}>
	...
	{#if chips.length}
		<div class="sticky top-3.5 z-20 my-4 px-6 flex w-fit max-w-full items-center">
			<div class="tab-scroller !h-10.5 max-h-10.5 flex max-w-full items-center gap-1 rounded-[calc(var(--radius,0.45rem)+4px)] border border-border/60 bg-muted/80 p-1 shadow-md backdrop-blur-md">
	...
	{:else if loading}
		...
		<div class="sticky top-3.5 z-20 my-4 px-6 flex w-fit max-w-full items-center" aria-hidden="true">
			<div class="tab-scroller !h-10.5 max-h-10.5 flex items-center gap-1 overflow-hidden rounded-[calc(var(--radius,0.45rem)+4px)] border border-border/60 bg-muted/80 p-1 shadow-md backdrop-blur-md">
